...
public class ChatCommandProcessorTest {
    ...
    /**
     * Проверка отправки сообщения незарегистриованного пользователя
     */
    @Test
    public void testUnregisteredUserMessage() {
        this.nick = null;
        
        ChatCommandProcessor cmdProcessor = new ChatCommandProcessor();
        
        CommandInput input = new CommandInput("test message", channelInfo);
        cmdProcessor.processCommand(input);
        
        String msg = outMsgs.poll();
        
        assertEquals(msg.contains("You have to register your nickname with #nick command. Type #quit to quit."), true);
    }

    /**
     * Проверка отправки сообещния зарег.-го пользователя
     */
    @Test
    public void testRegisteredUserMessage() {
        this.nick = "testUser";
        ...
        String msg = bcMsgs.poll();
        
        assertEquals(msg.contains("test message"), true);
    }
